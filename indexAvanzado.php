...
<body id="body">
	...
	<main>
		...
		<div class="row" id="row1">
			...
			<div class="container col-sm-7 p-4 mb-3 mt-3 bg-white  "> 
				<a href="indexIngreso.php">
				<div class="container d-flex justify-content-center p-4 mb-4" >
					<h3>Ingreso de productos</h3>
				</div>
				</a>
				<a href="indexEliminar.php">
				<div class="container d-flex justify-content-center p-4 mb-4" >
					<h3>Eliminar productos</h3>
				</div>
				</a>	
				<a href="indexModificar.php" >
				<div class="container d-flex justify-content-center p-4 mb-4" >
					<h3>Modificar productos</h3>
				</div>
				</a>	
				<a href="indexConsultar.php" >
				<div class="container d-flex justify-content-center p-4 mb-4" ">
